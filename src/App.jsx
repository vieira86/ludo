...
function App() {
  const [gameState, setGameState] = useState('login') // 'login', 'playing', 'finished', 'study'
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Aprenda Química Orgânica jogando!</p>
            </div>
